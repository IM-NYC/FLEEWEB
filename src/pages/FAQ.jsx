  ...
  return (
    <div className="min-h-screen" style={{ background: '#E0F7FC' }}>
      ...
      <div className="pt-32 pb-16 text-center px-6" style={{ background: '#CAF0F8' }}>
        ...
        >
          <span className="text-xs font-semibold tracking-widest uppercase" style={{ color: '#0077B6' }}>Support</span>
      ...
      <div className="pb-28 text-center px-6">
        <p className="mb-4" style={{ color: '#023E8A' }}>Still have questions?</p>
        <Link
